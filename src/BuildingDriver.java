public class BuildingDriver {
    public static void main(String[] args) {
        Building store1 = new Store("Marfusha's Bakery", "Bakery","Eastern District", 2, "Muffins", 500, 1300, 30,20,50, "muffin", "loaf of bread", "Doughnut", "cake");
        Building store2 = new Store("Dochka's Armory", "BlackSmith","Western District", 1,"Swords", 1000, 1700,25,45,30, "sword", "hammer", "axe", "shield");
